    ...
    def state(self) -> dict[str, object]:
        ...
        for row in repositories:
                ...
                ready_issue_discovery.append(
                    {
                        ...
                        "error": (
                            "Ready-issue discovery has not run yet"
                            if repository_ready
                            else f"Repository onboarding is {value['onboarding_state']}"
                        ),
                    }
                )
                continue
            ...
            if not repository_ready:
                ...
                discovery_error = f"Repository onboarding is {value['onboarding_state']}"
            ready_issue_discovery.append(
                {
                    "repository_id": repository_id,
                    "repository": value["identity"],
