...
class InterfaceTests(unittest.TestCase):
    ...
    def test_dashboard_renders_display_inputs_and_prefills_reonboarding_from_them(
        ...
        self.assertIn('id="repository-issues-title">Issues and Runs', dashboard)
        self.assertIn('id="active-issues-title">All active issues', dashboard)
        self.assertIn('id="active-runs"', dashboard)
        self.assertIn("r => String(r.repository_id) === selectedRepository", dashboard)
        self.assertIn("document.querySelector('#active-runs').innerHTML = activeRuns", dashboard)
